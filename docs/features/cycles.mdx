...
<CardGroup cols={3}>
  <Card title="Balance & Approvals" icon="wallet">
...
<Tabs>
  <Tab title="Balance & Approvals">
    ...
    <img
      src="/images/features/cycles/balance-approvals.png"
      alt="Cycles Balance and Approvals"
      className="rounded-lg border"
    />
    ...
    <CardGroup cols={2}>
      <Card title="Balance Queries" icon="scale">
  ...
  <Tab title="Convert & Faucet">
    ...
    <img
      src="/images/features/cycles/faucet-coupon.png"
      alt="Faucet Coupon Redemption"
      className="rounded-lg border"
    />
